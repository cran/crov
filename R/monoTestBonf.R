...
#' @examples monoDirTest(simultAlpha=0.05, OP_UMLE = c(0.256116, -0.5058427, 1.5799115),
#' OP_SE = c(0.229569, 0.6948236, 0.4059133))
#' @seealso \code{\link[crov:mdcp]{mdcp}}, \code{\link[VGAM:vglm]{vlgm}}.
...
#' @export
#'
monoTestBonf <- function(simultAlpha = 0.10, OP_UMLE, OP_SE){
  ...
  print("H_0: The parameter values are either isotonic or antitonic")
  print(aux.res$testRes)
  print(paste("Simultaneous P-value = ", round(ifelse(alpLB<0.5,alpLB,alpUB),7), sep = ""))
